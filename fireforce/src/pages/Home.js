  ...
  return (
    <div className="home-page">
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <div className="hero-stats">
              <div className="stat-item enhanced-card">
      ...
      <section className="state-selector">
        <div className="container">
          <div className="selector-card enhanced-card pattern-overlay">
            ...
            <form onSubmit={handleSubmit} className="state-form">
              ...
              <button type="submit" className="btn btn-primary btn-lg btn-enhanced">
                View Impact Report
              </button>
            </form>
          </div>
